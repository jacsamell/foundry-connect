...
export class FoundryConnectStack extends cdk.Stack {
    ...
    constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
        ...
        customCfnContactFlowLambda.addToRolePolicy(
            new PolicyStatement({
                actions: [
        ...
        new CustomResource(this, "contact-flow", {
            ...
            properties: {
                // dummy parameter to force an update when the lambda changes (including the flow file itself)
                version: customCfnContactFlowLambda.currentVersion.version,
            },
        });
    }
}
